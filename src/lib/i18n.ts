...
const DICT = {
  ...
  es: {
    ...
    retry: "Reintentar",
    channelTab: "Canal",
    channelDesc: "Drops gratis, comentario en vivo y señales de mercado. Un feed, cero ruido.",
    channelPinned: "Fijado",
    openInTg: "Abrir en Telegram",
    liveCommentary: "Comentario en vivo en el canal →",
    readingNow: "leyendo ahora",
    materialsToday: "posts hoy",
    oneLastThing: "Listo. Un último paso 🍒",
    onboardJoinBody: "Únete al canal para no perderte el próximo drop.",
    joinChannel: "Únete al canal",
    skipForNow: "Saltar",
    howItWorks: "Cómo funciona",
    bullet1: "Drops gratis, primero en saber",
    bullet2: "Comentario en vivo en cada partido",
    bullet3: "Señales de mercado cuando importa",
  },
} as const;
